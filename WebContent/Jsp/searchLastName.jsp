...
<center>
<h1>Search By LastName</h1></center><br/>
<form:form commandName="emp" action="searchlname.htm" class="form">
  <table align="center">
  <tr>
  <td style="text-align:right">Enter Employee ID:</td>
  <td style="text-align:left"><form:input path="lastname"value="lastname"/></td>
  </tr>
  <tr>
