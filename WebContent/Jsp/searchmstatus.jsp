...
<center>
<h1>Search By MaritalStatus</h1></center><br/>
<form:form commandName="emp" action="searchmstatus.htm" class="form">
  <table align="center">
  <tr>
  <td style="text-align:right">Enter Employee ID:</td>
  <td style="text-align:left"><form:input path="maritalStatus"value="mstatus"/></td>
  </tr>
  <tr>
